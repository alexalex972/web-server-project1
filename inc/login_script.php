...
<form action="" method="post">
   <div style="margin: 0 auto; max-width: 500px; margin-top: 50px; margin-bottom: 5px;">
      <table class="form-group">
         <label>Email :</label>
         <input required id="name" class="form-control" name="email" placeholder="john.doe@email.com" type="text">
         <label style="margin-top: .5rem;">Password :</label>
         <input required id="password" style="margin-bottom: 1rem;" class="form-control" name="password" placeholder="**********" type="password">
